# ---------------------------------------------------------------------------
# DIARY — R8 / ProGuard rules for the release build.
#
...
# ("DiaryDatabase_Impl"), R8 removed it, and the app died the moment the first
...
-keep class com.studiojavid.diary.data.local.**_Impl { *; }
...
-keepclassmembers class com.studiojavid.diary.data.local.** {
    <init>(...);
    <fields>;
}
...
-keep class com.studiojavid.diary.data.backup.** { *; }
-keep class com.studiojavid.diary.data.repo.** { *; }
...
-keep class com.studiojavid.diary.notifications.RescheduleWorker { *; }

# --- Manifest components ----------------------------------------------------
# Receivers/services are created reflectively by the framework.
-keep class com.studiojavid.diary.notifications.** { *; }
