...
//   ./gradlew assembleRelease -PapplicationId=com.example.diary -PappName="خاطرات"
// ---------------------------------------------------------------------------

val diaryApplicationId: String = (project.findProperty("applicationId") as String?) ?: "com.studiojavid.diary"
val diaryAppName: String = (project.findProperty("appName") as String?) ?: "دفتر خاطرات و تولد"
...
android {
    namespace = "com.studiojavid.diary"
    compileSdk = 35

    defaultConfig {
        applicationId = diaryApplicationId
        minSdk = 24
        targetSdk = 35
        ...
        resValue("string", "app_name_override", diaryAppName)
