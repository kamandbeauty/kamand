...
class Havato_I18N {
	...
	public static function map() {
		...
		self::$map = array(
            ...
            'chat_privacy_note'     => array(
				'fa' => 'گفتگوها روی سرور ذخیره می‌شوند و در صورت گزارش، توسط مدیریت بررسی می‌شوند.',
				'en' => 'Conversations are stored on the server and may be reviewed by a moderator if reported.',
				'tr' => 'Sohbetler sunucuda saklanır ve bildirilmesi hâlinde yönetici tarafından incelenebilir.',
			),
			...
			'menu_item_price'       => array( 'fa' => 'قیمت (تومان)', 'en' => 'Price (Toman)', 'tr' => 'Fiyat (Lira)' ),
