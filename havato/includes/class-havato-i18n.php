...
class Havato_I18N {
	...
	public static function map() {
		...
		self::$map = array(
			...
			'guest_requests_hint'   => array( 'fa' => 'مهمان‌ها روز و موضوعی را پیشنهاد داده‌اند. پذیرفتن، رویداد را نمی‌سازد؛ آن را در صفحه دورهمی‌ها بسازید.', 'en' => 'Guests have asked for a day and a subject. Accepting does not create the event — build it on the Events screen.', 'tr' => 'Misafirler bir gün ve konu istedi. Kabul etmek etkinliği oluşturmaz; Etkinlikler ekranından oluşturun.' ),
