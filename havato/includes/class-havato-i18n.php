...
class Havato_I18N {
	...
	public static function map() {
		...
		self::$map = array(
			...
			'how_many_arrived'      => array( 'fa' => 'چند نفر حاضر شدند؟', 'en' => 'How many arrived?' ),
			'arrived_n_of_m'        => array( 'fa' => '%s از %s', 'en' => '%s of %s' ),
			'penalty_points'        => array( 'fa' => 'امتیاز منفی', 'en' => 'Penalty points' ),
			...
			'stat_no_shows'         => array( 'fa' => 'عدم حضور', 'en' => 'No-shows' ),
			'stat_empty_seats'      => array( 'fa' => 'صندلی خالی‌مانده', 'en' => 'Empty seats left' ),
			...
			'q_phone'               => array( 'fa' => 'شماره تلفن همراه', 'en' => 'Mobile number' ),
			'phone_hint'            => array(
			...
			'err_phone'             => array( 'fa' => 'شماره تلفن معتبر نیست.', 'en' => 'That phone number is not valid.' ),
			'err_phone_taken'       => array( 'fa' => 'این شماره قبلاً ثبت شده است.', 'en' => 'That number is already registered.' ),
