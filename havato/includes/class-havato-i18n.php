...
class Havato_I18N {
	...
	public static function map() {
		...
		self::$map = array(
			...
			'guest_requests_hint'   => array( 'fa' => 'مهمان‌ها روز و موضوعی را پیشنهاد داده‌اند. با پذیرفتن، رویداد با همه میزهای شما ساخته می‌شود و پس از تایید مدیر نمایش داده می‌شود؛ میزها را می‌توانید در صفحه دورهمی‌ها تغییر دهید.', 'en' => 'Guests have asked for a day and a subject. Accepting creates the gathering with all your tables; it appears once an administrator approves it, and you can adjust the tables on the Events screen.', 'tr' => 'Misafirler bir gün ve konu istedi. Kabul ettiğinizde buluşma tüm masalarınızla oluşturulur; yönetici onayladıktan sonra görünür ve masaları Etkinlikler ekranından değiştirebilirsiniz.' ),
			...
			'request_became_event'  => array( 'fa' => 'پیشنهاد پذیرفته شد و رویداد ساخته شد؛ پس از تایید مدیر نمایش داده می‌شود.', 'en' => 'Suggestion accepted and the gathering created. It appears once an administrator approves it.', 'tr' => 'Öneri kabul edildi ve buluşma oluşturuldu. Yönetici onayladıktan sonra görünecek.' ),
			'request_need_tables'   => array( 'fa' => 'پیشنهاد پذیرفته شد، اما تا وقتی میزی تعریف نکنید رویداد ساخته نمی‌شود.', 'en' => 'Suggestion accepted, but no gathering was created because your café has no tables defined yet.', 'tr' => 'Öneri kabul edildi, ancak kafenizde tanımlı masa olmadığı için buluşma oluşturulmadı.' ),
