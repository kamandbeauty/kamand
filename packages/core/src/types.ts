...
export interface Invoice {
  ...
  isOfficial: boolean;
  /**
   * فروش/خرید نقدی — پول همان لحظه رد و بدل شده است.
   *
   * فاکتور نقدی مستقیم به صندوق می‌نشیند، نه حساب دریافتنی. بدون
   * این، هر فروش نقدی یک طلب باز می‌ساخت که هرگز تسویه نمی‌شد و
   * فهرست بدهکاران را پر از رکورد بی‌معنی می‌کرد.
   */
  isCash?: boolean;
  /** صندوقی که پول نقد به آن رفته — پیش‌فرض صندوق اصلی */
  treasuryId?: ID | null;
  lines: InvoiceLine[];
