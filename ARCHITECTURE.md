# معماری و راهنمای سیستم «فاکتور فیدا» (Architecture Overview)

اپلیکیشن «فاکتور فیدا» بر پایه اصول **معماری تمیز (Clean Architecture)** و معماری لایه‌ای Flutter/Dart پیاده‌سازی شده است.
