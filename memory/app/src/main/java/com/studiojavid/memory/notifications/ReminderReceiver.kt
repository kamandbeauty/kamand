...
class ReminderReceiver : BroadcastReceiver() {
                ...
                when (intent.action) {
                    ...
                    ACTION_SNOOZE -> {
                        ...
                        val title = intent.getStringExtra(EXTRA_TITLE)
                            ?: MemoryDatabase.get(appContext).taskDao().findById(taskId)?.title
                        if (title != null) {
                        ...
                        val task = MemoryDatabase.get(appContext).taskDao().findById(taskId)
    ...
    companion object {
        const val ACTION_REMIND = "com.studiojavid.memory.action.REMIND"
        const val ACTION_COMPLETE = "com.studiojavid.memory.action.COMPLETE"
        const val ACTION_SNOOZE = "com.studiojavid.memory.action.SNOOZE"
