...
val LocalMemoryColors = staticCompositionLocalOf { LightMemoryColors }

object MemoryTheme {
    val colors: MemoryColors
        @Composable get() = LocalMemoryColors.current
}

val MemoryShapes = Shapes(
...
fun MemoryTheme(
    ...
    val tokens = memoryColorsOf(palette, dark)
    ...
    CompositionLocalProvider(LocalMemoryColors provides tokens) {
        MaterialTheme(
            colorScheme = scheme,
