...
//   ./gradlew assembleRelease -PapplicationId=com.example.memory -PappName="خاطرات"
// ---------------------------------------------------------------------------

val memoryApplicationId: String = (project.findProperty("applicationId") as String?) ?: "com.studiojavid.memory"
val memoryAppName: String = (project.findProperty("appName") as String?) ?: "دفتر خاطرات و تولد"
...
android {
    namespace = "com.studiojavid.memory"
    compileSdk = 35
    ...
    defaultConfig {
        ...
        resValue("string", "app_name_override", memoryAppName)
