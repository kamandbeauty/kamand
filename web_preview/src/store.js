...
const KEY = 'saina_track_order_v2'
...
const defaultSettings = {
  ...
  postNewTab: false,
  disableVirtual: true,
  disableProgressAccount: false,
  disableProgressThanks: false,
  disableIconsColumn: false,
  dokanTracking: false,
  skipRequired: false,
  formPlaceholder: 'لطفا شماره موبایل یا شماره سفارش خود را وارد کنید',
  step1Status: 'processing',
  step2Status: 'on-hold',
  step3Status: 'packing',
  step4Status: 'completed',
  step4ToPost: true,
  step5Status: 'delivered',
  step5Delivered: true,
  enableDelivered: true,
  disableConfirm: false,
  tooltipCompleted: 'سفارش شماره {order_id} رهگیری {trackingurl} توسط {username} در تاریخ {senddate} ارسال گردیده',
  tooltipDelivered: 'سفارش شماره {order_id} در تاریخ {deliverydate} تحویل مشتری گردیده',
  tooltipPeykCompleted: 'سفارش شماره {order_id} توسط {peyk} در تاریخ {senddate} ارسال گردیده',
  tooltipPeykDelivered: 'سفارش شماره {order_id} در تاریخ {deliverydate} تحویل مشتری گردیده',
  peykSmsStatus: 'packing',
  peykSmsText: 'سفارش شماره {order_id} در تاریخ {senddate} که رهگیری {trackingurl} تحویل پست پیشتاز گردید',
  peykCities: '',
  peykMethod: '',
  peykNationwide: false,
  showUser: true,
  showPayment: true,
  ...
  showStateBeside: true,
  sharedProgressImage: false,
  uploadFormImage: false,
  logo: '',
  iconSize: 32,
  colorProgress: '#4caf50',
  colorFormBtn: '#4caf50',
  colorTableHeader: '#e0e0e0',
  colorTableHeaderText: '#333333',
  colorPostBtn: '#f9a825',
  colorPostBtnText: '#111111',
  progressStyle: 'digi',
