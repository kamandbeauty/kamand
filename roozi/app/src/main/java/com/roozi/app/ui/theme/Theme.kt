...
val LocalRooziColors = staticCompositionLocalOf { LightRooziColors }

object RooziTheme {
    val colors: RooziColors
        @Composable get() = LocalRooziColors.current
}

val RooziShapes = Shapes(
...
fun RooziTheme(
    ...
    CompositionLocalProvider(LocalRooziColors provides tokens) {
        MaterialTheme(
            colorScheme = scheme,
            typography = RooziTypography,
            shapes = RooziShapes,
            content = content
        )
    }
