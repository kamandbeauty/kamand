...
import com.roozi.app.ui.components.ChipRow
    ...
    Box(Modifier.fillMaxWidth().padding(top = 12.dp, bottom = 4.dp), contentAlignment = Alignment.Center) {
        Box(
            Modifier
                ...
                .background(RooziTheme.colors.textSecondary.copy(alpha = 0.3f), RoundedCornerShape(3.dp))
        )
    }
}
...
private fun fieldColors() = TextFieldDefaults.colors(
    focusedContainerColor = RooziTheme.colors.surfaceMuted,
    unfocusedContainerColor = RooziTheme.colors.surfaceMuted,
    disabledContainerColor = RooziTheme.colors.surfaceMuted,
    focusedIndicatorColor = RooziTheme.colors.coral,
    unfocusedIndicatorColor = androidx.compose.ui.graphics.Color.Transparent,
    cursorColor = RooziTheme.colors.coral,
    focusedLabelColor = RooziTheme.colors.coral,
    unfocusedLabelColor = RooziTheme.colors.textSecondary
)
