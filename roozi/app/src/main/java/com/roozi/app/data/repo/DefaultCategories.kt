...
object DefaultCategories {
    ...
    fun seed(): List<CategoryEntity> = listOf(
        ...
        CategoryEntity(name = "کار", icon = "💼", color = CORAL, builtInKey = WORK, createdAt = 2),
        ...
        CategoryEntity(name = "مطالعه", icon = "📚", color = TURQUOISE, builtInKey = STUDY, createdAt = 5),
        CategoryEntity(name = "سایر", icon = "✨", color = PINK, builtInKey = OTHER, createdAt = 6)
    )
    ...
    val palette: List<Int> = listOf(
        CORAL, ORANGE, 0xFFFFC93C.toInt(), MINT, TURQUOISE, PURPLE, PINK, 0xFF7BC96F.toInt()
    )
