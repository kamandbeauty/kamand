# ---------------------------------------------------------------------------
# ROOZI — R8 / ProGuard rules for the release build.
#
...
# ("RooziDatabase_Impl"), R8 removed it, and the app died the moment the first
...
-keep class com.roozi.app.data.local.**_Impl { *; }
...
-keepclassmembers class com.roozi.app.data.local.** {
    <init>(...);
    <fields>;
}
...
-keep class com.roozi.app.data.repo.** { *; }
...
-keep class com.roozi.app.notifications.RescheduleWorker { *; }

# --- Manifest components ----------------------------------------------------
# Receivers/services are created reflectively by the framework.
-keep class com.roozi.app.widget.** { *; }
-keep class com.roozi.app.notifications.** { *; }
