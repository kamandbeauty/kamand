...
- پس از ذخیره، همان داده روی Order می‌نشیند (و وضعیت سفارش‌های در حال انتظار به
  SHIPPED می‌رسد)؛ فاکتور/جزئیات سفارش همان اطلاعات را می‌بیند — هیچ ورودی دوم
  نیست. (در UI فاکتور روبی بخشی جدید اختراع نشده؛ داده فقط متصل است.)
