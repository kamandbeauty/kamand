    ...
    <div style={{ display: 'grid', gap: 18, maxWidth: 860 }}>
      {done && (
        <Banner tone="success" title={`${done} بسته شد`}>
          ...
          مانده‌های دائمی آغاز گردید. دوره خودکار قفل شد. گزارش سود و زیان
          همین سال همچنان در دسترس است و طلب مشتریان دست‌نخورده باقی می‌ماند.
        </Banner>
      )}
      ...
      <Card title="بستن سال">
        <p className="small muted" style={{ marginBottom: 12 }}>
          با بستن سال این اسناد ثبت می‌شوند: <strong>اختتامیه</strong> (صفر کردن
          حساب‌های موقت)، در صورت انتخاب <strong>تسهیم سود</strong>،
          <strong> بستن حساب‌های دائمی</strong> در آخرین روز سال و
          <strong> افتتاحیهٔ سال بعد</strong> در نخستین روز سال جدید. دو سند
          آخر قرینهٔ یکدیگرند تا مانده‌ها در گزارش‌های تجمعی دو بار شمرده
          نشوند. سپس دوره خودکار قفل می‌گردد.
        </p>
        {!mayClose ? (
