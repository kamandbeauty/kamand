# ---------------------------------------------------------------------------
# APP2 — R8 / ProGuard rules for the release build.
#
...
# ("App2Database_Impl"), R8 removed it, and the app died the moment the first
...
-keep class com.javidstudio.app2.data.local.**_Impl { *; }
...
-keepclassmembers class com.javidstudio.app2.data.local.** {
    <init>(...);
    <fields>;
}
...
-keep class com.javidstudio.app2.data.backup.** { *; }
-keep class com.javidstudio.app2.data.repo.** { *; }
...
-keep class com.javidstudio.app2.notifications.RescheduleWorker { *; }

# --- Manifest components ----------------------------------------------------
# Receivers/services are created reflectively by the framework.
-keep class com.javidstudio.app2.widget.** { *; }
-keep class com.javidstudio.app2.notifications.** { *; }
