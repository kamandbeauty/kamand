 ...
 */
fun app2ColorsOf(palette: ThemePalette, dark: Boolean): App2Colors {
    val p = if (dark) palette.dark else palette.light
    val base = if (dark) DarkApp2Colors else LightApp2Colors
    return base.copy(
        isDark = dark,
...
val LightApp2Colors = App2Colors(
    isDark = false,
 ...
 */
fun App2Colors.timeOfDayGradient(hour: Int): List<Color> {
    val warm: Color
    val cool: Color
    when (hour) {
