...
abstract class App2Database : RoomDatabase() {
    ...
    companion object {
        ...
        fun get(context: Context): App2Database = instance ?: synchronized(this) {
            instance ?: build(context.applicationContext).also { instance = it }
        }

        private fun build(context: Context): App2Database =
            Room.databaseBuilder(context, App2Database::class.java, "app2.db")
