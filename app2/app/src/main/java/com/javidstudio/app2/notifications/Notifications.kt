...
object Notifications {
     ...
     */
    const val CHANNEL_ID = "app2_task_reminders_v3"

    private val LEGACY_CHANNEL_IDS = listOf("app2_task_reminders", "app2_task_reminders_v2")
     ...
     */
    const val BIRTHDAY_CHANNEL_ID = "app2_birthdays"
    ...
    fun show(context: Context, taskId: Long, title: String) {
        ...
        val doneIntent = PendingIntent.getBroadcast(
            ...
            Intent(context, ReminderReceiver::class.java).apply {
                ...
                data = android.net.Uri.parse("app2://complete/$taskId")
        ...
        val snoozeIntent = PendingIntent.getBroadcast(
            ...
            Intent(context, ReminderReceiver::class.java).apply {
                ...
                data = android.net.Uri.parse("app2://snooze/$taskId")
                putExtra(ReminderReceiver.EXTRA_TASK_ID, taskId)
