...
import com.javidstudio.app2.core.CrashReporter
import com.javidstudio.app2.core.LocaleContext
import com.javidstudio.app2.notifications.Notifications
import com.javidstudio.app2.data.backup.BackupManager
import com.javidstudio.app2.data.prefs.AppLanguage
import com.javidstudio.app2.data.prefs.UserPreferences
import com.javidstudio.app2.ui.LocalDateFormatter
import com.javidstudio.app2.ui.MainViewModel
import com.javidstudio.app2.ui.components.CrashReportScreen
import com.javidstudio.app2.ui.App2AppScaffold
import com.javidstudio.app2.ui.TasksViewModel
import com.javidstudio.app2.ui.onboarding.OnboardingScreen
import com.javidstudio.app2.ui.rememberDateFormatter
...
class MainActivity : ComponentActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        val app = application as App2App
        ...
        setContent {
            ...
            App2Theme(themeMode = current.theme, palette = current.palette) {
    ...
    companion object {
        const val EXTRA_QUICK_ADD = "app2.extra.quick_add"
    }
}
