...
fun App2Card(
    ...
    color: Color = App2Theme.colors.surface,
    ...
    Surface(
        ...
        color = color,
        shape = shape,
        shadowElevation = if (App2Theme.colors.isDark) 0.dp else 3.dp,
        tonalElevation = 0.dp,
        border = border ?: if (App2Theme.colors.isDark) BorderStroke(1.dp, App2Theme.colors.outline) else null
    ) {
...
fun <T> ChipRow(
    ...
    modifier: Modifier = Modifier,
    accent: @Composable (T) -> Color = { App2Theme.colors.coral },
...
fun SectionHeader(
    ...
    Row(
        ...
        Text(
            ...
            color = App2Theme.colors.textPrimary
        )
        trailing?.invoke()
    }
}
 ...
 *
 * Deliberately does NOT use [App2Card]: that draws an elevation shadow, and a
