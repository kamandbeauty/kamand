...
//   ./gradlew assembleRelease -PapplicationId=com.example.app2 -PappName="اپ"
// ---------------------------------------------------------------------------

val app2ApplicationId: String = (project.findProperty("applicationId") as String?) ?: "com.javidstudio.app2"
val app2AppName: String = (project.findProperty("appName") as String?) ?: "اپ دوم"
...
android {
    namespace = "com.javidstudio.app2"
    compileSdk = 35

    defaultConfig {
        applicationId = app2ApplicationId
        minSdk = 24
        targetSdk = 35
        ...
        resValue("string", "app_name_override", app2AppName)
